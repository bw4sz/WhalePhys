...
cat("
   ...
   logit(phi[i,g,t,2]) <- Foraging + beta1 * cos(2*pi*hour[i,g,t-1]) * Foraging[state[i,g,t-1]] 
    ...
    #duration[i,g,t,u] ~ dnorm(duration_mu[state[i,g,t]],duration_tau[state[i,g,t]])T(0,)
    ...
    #duration_mu[2] ~ dnorm(5,0.001)T(0.1,)
    ...
    depth_tau[1] ~ dunif(100,1000)
    depth_tau[2] ~ dunif(100,1000)
    depth_tau[3] <-5000
