...
if(newModel){
 system.time(diving<-jags(model.file = "Bayesian/NestedDive_NoInd.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=10000,n.burnin=9500,n.thin=1,DIC=FALSE,parallel=F,codaOnly = c("state", "sub_state")))
  }
