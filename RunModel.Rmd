...
mdat<-mdat %>% filter(Animal %in% c("131134","131127"))
...
#prior cov shape
R <- diag(c(1,1))
data=list(divedepth=maxdive,argos=obs,steps=steps,R=R,ind=ind,j=j,idx=idx,tracks=tracks,argos_class=obs_class)

#paramters to track
pt<-c("Traveling","Foraging","gamma","depth_mu","depth_tau","dive_new","state","E","Enew")
...
#single index
splitpc[c("Traveling","Foraging","depth_mu","depth_tau")]<-lapply(splitpc[c("Traveling","Foraging","depth_mu","depth_tau")],function(x){
