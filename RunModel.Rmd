...
mdat<-mdat %>% filter(Animal %in% c("131132","131130","131115","131116"))
...
if(newModel){
  system.time(diving<-jags.parallel(model.file = "Bayesian/NestedDive.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=5000,n.burnin=4900,n.thin=2,DIC=FALSE,inits = InitStage))
  }
...
if(newModel){
  system.time(foraging<-jags.parallel(model.file = "Bayesian/Foraging.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=10000,n.burnin=9900,n.thin=2,DIC=FALSE))
  }
