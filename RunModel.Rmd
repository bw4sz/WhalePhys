...
mdat<-mdat %>% filter(Animal %in% c("131111","131115","131116","154187","131134","131128","131130"))
...
if(newModel){
  system.time(diving<-jags.parallel(model.file = "Bayesian/TimeDive.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=20000,n.burnin=19000,n.thin=2,DIC=FALSE,inits = InitStage))
  }
