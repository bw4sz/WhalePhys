...
\end{matrix}
$$
$$logit(\phi_{traveling}) = \alpha_{Behavior_{t-1}} * \beta \text{ dive depth}_{i,g,t} $$
...
mdat<-mdat %>% filter(Animal %in% c("131127","131136","131132","131133","154187","131134","131116"))
...
if(newModel){
  system.time(diving<-jags.parallel(model.file = "Bayesian/Diving.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=15000,n.burnin=14500,n.thin=2,DIC=FALSE))
  }
...
if(newModel){
  system.time(foraging<-jags.parallel(model.file = "Bayesian/Foraging.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=15000,n.burnin=14500,n.thin=2,DIC=FALSE))
  }
