...
if(newModel){
  system.time(diving<-jags.parallel(model.file = "Bayesian/ThreeState.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=5000,n.burnin=4800,n.thin=2,DIC=FALSE))
  }
...
if(newModel){
  system.time(foraging<-jags.parallel(model.file = "Bayesian/Foraging.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=5000,n.burnin=4800,n.thin=2,DIC=FALSE))
  }
