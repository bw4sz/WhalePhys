...
if(newModel){
  system.time(jagM<-jags.parallel(model.file = "Bayesian/Foraging.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=10000,n.burnin=9000,n.thin=2,DIC=FALSE))
}
...
print("Mean foraging hours:", mean(test_time),sep=" ")
