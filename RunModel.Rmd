...
if(newModel){
  system.time(diving<-jags(model.file = "Bayesian/NestedDive.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=10000,n.burnin=9900,n.thin=2,DIC=FALSE,inits = InitStage))
  }
