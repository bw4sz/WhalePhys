...
mdat<-mdat %>% filter(Animal %in% c("131127","131136","131132","131133","154187","131134"))
...
if(newModel){
  system.time(foraging<-jags.parallel(model.file = "Bayesian/Foraging.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=4000,n.burnin=3500,n.thin=2,DIC=FALSE))
  }
