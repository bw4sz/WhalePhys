...
#paramters to track
pt<-c("Traveling","Foraging","gamma","depth_mu","depth_tau","dive_new","state","E","Enew","beta","beta2")
...
#single index
splitpc[c("Traveling","gamma","beta","beta","depth_mu","depth_tau")]<-lapply(splitpc[c("Traveling","gamma","alpha_hours","beta","beta2","depth_mu","depth_tau")],function(x){
