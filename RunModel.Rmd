...
mdat<-mdat %>% filter(Animal %in% c("131132","131130","131115","131116","131111","154187","131128","131132"))
...
if(newModel){
  system.time(diving<-jags.parallel(model.file = "Bayesian/NestedDive.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=15000,n.burnin=14800,n.thin=2,DIC=FALSE,inits = InitStage))
  }
